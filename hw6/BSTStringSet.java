...
public class BSTStringSet implements SortedStringSet, Iterable<String> {
    ...
    public Iterator<String> iterator(String low, String high) {
        return new SortedStringSetIterator(low, high);
    }
    ...
    /** Iterator for SortedStringSet. */
    private class SortedStringSetIterator implements Iterator<String> {
        /** Stack of nodes to be delivered.  The values to be delivered
         *  are (a) the label of the top of the stack, then (b)
         *  the labels of the right child of the top of the stack inorder,
         *  then (c) the nodes in the rest of the stack (i.e., the result
        ...
        /** A new SortedStringSetIterator.
         *
         * @param low The low threshold.
         * @param high The high threshold.
         */
        SortedStringSetIterator(String low, String high) {
            this._high = high;
            init(low);
        }
        ...
        /** Stores the upper limit of the interator. */
